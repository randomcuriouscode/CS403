...
(cl:defmethod cl:initialize-instance :after ((m <GetCommandVelSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCommandVelSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compsci403_assignment5-srv:<GetCommandVelSrv-request> is deprecated: use compsci403_assignment5-srv:GetCommandVelSrv-request instead.")))

(cl:ensure-generic-function 'v_0-val :lambda-list '(m))
(cl:defmethod v_0-val ((m <GetCommandVelSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:v_0-val is deprecated.  Use compsci403_assignment5-srv:v_0 instead.")
  (v_0 m))

(cl:ensure-generic-function 'w_0-val :lambda-list '(m))
(cl:defmethod w_0-val ((m <GetCommandVelSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:w_0-val is deprecated.  Use compsci403_assignment5-srv:w_0 instead.")
  (w_0 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCommandVelSrv-request>)))
  ...
  "compsci403_assignment5/GetCommandVelSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCommandVelSrv-request)))
  "Returns string type for a service object of type 'GetCommandVelSrv-request"
  "compsci403_assignment5/GetCommandVelSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetCommandVelSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetCommandVelSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compsci403_assignment5-srv:<GetCommandVelSrv-response> is deprecated: use compsci403_assignment5-srv:GetCommandVelSrv-response instead.")))

(cl:ensure-generic-function 'C_v-val :lambda-list '(m))
(cl:defmethod C_v-val ((m <GetCommandVelSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:C_v-val is deprecated.  Use compsci403_assignment5-srv:C_v instead.")
  (C_v m))

(cl:ensure-generic-function 'C_w-val :lambda-list '(m))
(cl:defmethod C_w-val ((m <GetCommandVelSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:C_w-val is deprecated.  Use compsci403_assignment5-srv:C_w instead.")
  (C_w m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetCommandVelSrv-response>)))
  ...
  "compsci403_assignment5/GetCommandVelSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCommandVelSrv-response)))
  "Returns string type for a service object of type 'GetCommandVelSrv-response"
  "compsci403_assignment5/GetCommandVelSrvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetCommandVelSrv)))
  ...
  "compsci403_assignment5/GetCommandVelSrv")