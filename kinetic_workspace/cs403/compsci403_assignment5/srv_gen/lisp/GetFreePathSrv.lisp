...
(cl:defmethod cl:initialize-instance :after ((m <GetFreePathSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetFreePathSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compsci403_assignment5-srv:<GetFreePathSrv-request> is deprecated: use compsci403_assignment5-srv:GetFreePathSrv-request instead.")))

(cl:ensure-generic-function 'laser_scan-val :lambda-list '(m))
(cl:defmethod laser_scan-val ((m <GetFreePathSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:laser_scan-val is deprecated.  Use compsci403_assignment5-srv:laser_scan instead.")
  (laser_scan m))

(cl:ensure-generic-function 'v-val :lambda-list '(m))
(cl:defmethod v-val ((m <GetFreePathSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:v-val is deprecated.  Use compsci403_assignment5-srv:v instead.")
  (v m))

(cl:ensure-generic-function 'w-val :lambda-list '(m))
(cl:defmethod w-val ((m <GetFreePathSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:w-val is deprecated.  Use compsci403_assignment5-srv:w instead.")
  (w m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetFreePathSrv-request>)))
  ...
  "compsci403_assignment5/GetFreePathSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetFreePathSrv-request)))
  "Returns string type for a service object of type 'GetFreePathSrv-request"
  "compsci403_assignment5/GetFreePathSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetFreePathSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetFreePathSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compsci403_assignment5-srv:<GetFreePathSrv-response> is deprecated: use compsci403_assignment5-srv:GetFreePathSrv-response instead.")))

(cl:ensure-generic-function 'is_obstacle-val :lambda-list '(m))
(cl:defmethod is_obstacle-val ((m <GetFreePathSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:is_obstacle-val is deprecated.  Use compsci403_assignment5-srv:is_obstacle instead.")
  (is_obstacle m))

(cl:ensure-generic-function 'free_path_length-val :lambda-list '(m))
(cl:defmethod free_path_length-val ((m <GetFreePathSrv-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:free_path_length-val is deprecated.  Use compsci403_assignment5-srv:free_path_length instead.")
  (free_path_length m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetFreePathSrv-response>)))
  ...
  "compsci403_assignment5/GetFreePathSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetFreePathSrv-response)))
  "Returns string type for a service object of type 'GetFreePathSrv-response"
  "compsci403_assignment5/GetFreePathSrvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetFreePathSrv)))
  ...
  "compsci403_assignment5/GetFreePathSrv")