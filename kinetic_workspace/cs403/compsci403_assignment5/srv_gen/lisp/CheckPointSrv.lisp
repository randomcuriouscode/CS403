...
(cl:defmethod cl:initialize-instance :after ((m <CheckPointSrv-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckPointSrv-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compsci403_assignment5-srv:<CheckPointSrv-request> is deprecated: use compsci403_assignment5-srv:CheckPointSrv-request instead.")))

(cl:ensure-generic-function 'P-val :lambda-list '(m))
(cl:defmethod P-val ((m <CheckPointSrv-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader compsci403_assignment5-srv:P-val is deprecated.  Use compsci403_assignment5-srv:P instead.")
  (P m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckPointSrv-request>)))
  ...
  "compsci403_assignment5/CheckPointSrvRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckPointSrv-request)))
  "Returns string type for a service object of type 'CheckPointSrv-request"
  "compsci403_assignment5/CheckPointSrvRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CheckPointSrv-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CheckPointSrv-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name compsci403_assignment5-srv:<CheckPointSrv-response> is deprecated: use compsci403_assignment5-srv:CheckPointSrv-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CheckPointSrv-response>)))
  ...
  "compsci403_assignment5/CheckPointSrvResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckPointSrv-response)))
  "Returns string type for a service object of type 'CheckPointSrv-response"
  "compsci403_assignment5/CheckPointSrvResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CheckPointSrv)))
  ...
  "compsci403_assignment5/CheckPointSrv")