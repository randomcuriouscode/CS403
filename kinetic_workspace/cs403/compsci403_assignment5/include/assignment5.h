...
const float S_MAX = .6f; // max stopping distance .25m by V_max^2 / (2a_max)
const float R_ROBOT = .35f; // radius of robot is .18m
...
*/
void ProjectRangeFinderToRobotRef(const sensor_msgs::LaserScan &msg, const Eigen::Matrix3f &R,
                                  const Eigen::Vector3f &T, sensor_msgs::PointCloud &translated_pc)
{
